...
var nombreArchivo = "src/mensajes.json";
...
var myWSServer = io(myServer);

//Nuevas conexiones
myWSServer.on("connection", /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(socket) {
    var mensajesNuevoUsuario;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 4:
            mensajesNuevoUsuario = _context2.sent;
            socket.emit("listadoDeMensajes", mensajesNuevoUsuario);

            //Mensajes del lado del ciente
            socket.on("mensaje", /*#__PURE__*/function () {
              var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(mensaje) {
                var mensajes;
