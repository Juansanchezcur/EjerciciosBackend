...
var _require2 = require("../../src/config/index"),
  administrador = _require2.administrador;
var fs = require("fs");
var fileName = "./productos.json";
...
rutaProductos.post("/", /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(req, res) {
    var productos, _req$body, name, description, photo, price, stock, nuevoProducto, productosString;
...
rutaProductos.put("/:id", /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(req, res) {
    var productos, id, _req$body2, name, description, photo, price, stock, indice, productoActualizado, productosString;
...
rutaProductos["delete"]("/:id", /*#__PURE__*/function () {
  var _ref5 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(req, res) {
    var productos, id, indice, productosString;
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          ...
          case 7:
            ...
            id = req.params.id;
            indice = productos.filter(function (unProducto) {
              return unProducto.id == id;
            });
